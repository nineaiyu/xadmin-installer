...
function post_install() {
  ...
  echo "$(gettext 'For more commands, you can enter ./xadmin.sh --help to understand')"
  ...
  echo "$(gettext 'Documentation'): https://docs.dvcloud.xin/"
  echo -e "\n"
}
...
function main() {
  ...
  echo_green "\n>>> $(gettext 'Install and Configure xAdmin')"
